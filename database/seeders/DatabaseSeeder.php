...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Banner::updateOrCreate(
            ...
            [
                'eyebrow' => 'Автотовари, запчастини, сервісні комплекти',
                ...
                'button_url' => '/catalog',
                'secondary_button_text' => 'Швидка консультація',
